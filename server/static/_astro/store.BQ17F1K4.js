...
function S() {
  if (f > 1) f--;
    ...
    for (
      ...
      var s = p;
      for (p = void 0, d++; s !== void 0; ) {
        var e = s.u;
        if (((s.u = void 0), (s.f &= -3), !(8 & s.f) && E(s)))
          try {
            s.c();
          } catch (n) {
            t || ((i = n), (t = !0));
...
r.prototype.U = function (i) {
  ...
  if (this.t !== void 0) {
    var s = i.e,
      e = i.x;
    s !== void 0 && ((s.x = e), (i.e = void 0)),
      e !== void 0 && ((e.e = s), (i.x = void 0)),
      i === this.t &&
        ((this.t = e),
        e === void 0 &&
          O(function () {
...
function P(i) {
  for (var t = i.s; t !== void 0; t = t.n) {
    var s = t.S.n;
    if ((s !== void 0 && (t.r = s), (t.S.n = t), (t.i = -1), t.n === void 0)) {
      i.s = t;
      break;
    }
  }
...
function M(i) {
  for (var t = i.s, s = void 0; t !== void 0; ) {
    var e = t.p;
    t.i === -1
      ? (t.S.U(t), e !== void 0 && (e.n = t.n), t.n !== void 0 && (t.n.p = e))
      : (s = t),
      (t.S.n = t.r),
...
c.prototype.h = function () {
  ...
  if (((this.g = m), (this.f |= 1), this.i > 0 && !E(this)))
    return (this.f &= -2), !0;
  var i = o;
  try {
    P(this), (o = this);
    ...
    (this.v = s), (this.f |= 16), this.i++;
  }
  return (o = i), M(this), (this.f &= -2), !0;
};
c.prototype.S = function (i) {
  ...
  r.prototype.S.call(this, i);
};
c.prototype.U = function (i) {
  if (this.t !== void 0 && (r.prototype.U.call(this, i), this.t === void 0)) {
    this.f &= -33;
...
function w(i) {
  ...
  (i.x = void 0), (i.s = void 0), k(i);
}
function I(i) {
  if (o !== this) throw new Error("Out-of-order effect");
  M(this), (o = i), (this.f &= -2), 8 & this.f && w(this), S();
}
function v(i, t) {
  (this.x = i),
    (this.m = void 0),
...
v.prototype.S = function () {
  if (1 & this.f) throw new Error("Cycle detected");
  (this.f |= 1), (this.f &= -9), k(this), P(this), f++;
  var i = o;
  return (o = this), I.bind(this, i);
};
...
const g = h([]),
  W = h("srt");
u(() => l.value?.state ?? "stopped");
const D = u(() => l.value?.state === "running");
u(() => l.value?.state === "stopping");
u(() => l.value?.chunks_processed ?? 0);
const A = u(() => {
  const i = l.value?.modules;
  return i ? Object.fromEntries(i.map((t) => [t.name, t])) : {};
});
u(() => {
  const i = A.value;
...
const B = u(() => {
    const i = l.value,
      t = i?.system_metrics ?? i?.system ?? {},
      s = i?.uptime_seconds ?? 0,
      e = i?.chunks_processed ?? 0,
      n = s > 0 ? e / s : 0;
    return {
    ...
    const i = L.value,
      t =
        H.value === "remote"
          ...
          : "127.0.0.1",
      s = L.value?.input?.type ?? "srt";
    W.value = s;
    const e = i?.input?.srt?.port ?? 9e3,
      n = i?.input?.rtmp?.port ?? 1935,
      a = i?.server?.port ?? 9999,
      b = `srt://${t}:${e}`,
      _ = `rtmp://${t}:${n}`,
      j = `http://${t}:${a}/hls/stream.m3u8`,
      $ = `http://${t}:${a}/player`;
    return {
      host: t,
      inputType: s,
      ...
      streamUrl: j,
      playerUrl: $,
      srtLabel: s === "rtmp" ? "RTMP:" : "SRT:",
      primaryUrl: s === "rtmp" ? _ : b,
      primaryLabel: s === "rtmp" ? "RTMP:" : "SRT:",
    };
  }),
  V = u(() => {
    const i = g.value;
    return i.length === 0 ? 0 : i.reduce((t, s) => t + s, 0) / i.length;
  });
function q(i) {
  l.value = i;
  const t = i?.uptime_seconds ?? 0,
    s = i?.chunks_processed ?? 0,
    e = i?.avg_processing_time_ms ?? 0,
    n = e > 0 ? 1e3 / e : t > 0 ? s / t : 0;
  if (n > 0) {
    const a = [...g.value, n];
    g.value = a.slice(-10);
  }
...
function F(i, t) {
  const s = { timestamp: new Date().toISOString(), level: i, message: t };
  U.value = [...U.value.slice(-999), s];
}
function G() {
  g.value = [];
}
...
class Z {
  ...
  addLog(t) {
    const s = [...this.state.logs, t].slice(-500);
    this.setState({ logs: s });
  }
  setLoading(t) {
