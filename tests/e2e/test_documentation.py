...
class TestDocumentationIndex:
    ...
    def test_docs_index_exists(self, docs_index_content):
...
class TestAstroPagesStructure:
    ...
    def test_dashboard_page_exists(self, dashboard_page):
        """Test that dashboard page exists."""
        assert dashboard_page is not None

    def test_dashboard_imports_base_layout(self, dashboard_page):
    ...
    def test_player_page_exists(self, player_page):
        """Test that player page exists."""
        assert player_page is not None

    def test_player_uses_layout(self, player_page):
...
class TestAstroConfiguration:
    ...
    def test_astro_config_exists(self, astro_config):
        """Test that Astro config exists."""
        assert astro_config is not None

    def test_astro_config_has_output_setting(self, astro_config):
    ...
    def test_astro_config_has_build_setting(self, astro_config):
...
class TestAstroPackageJson:
    ...
    def test_has_astro_dependency(self, package_json):
