...
class TestLatencyCalculation:
    ...
    def test_typical_latency_with_2s_chunks(self):
...
class TestParallelProcessing:
    ...
    def test_thread_parallel_mode(self):
        """Test pipeline uses thread_parallel mode."""
        mode = 'thread_parallel'
        assert mode == 'thread_parallel'
    
    def test_max_concurrent_chunks_allows_parallelism(self):
    ...
    def test_buffer_size_for_parallelism(self):
...
class TestOBSKeyframe:
    ...
    def test_keyframe_interval_recommendation(self):
    ...
    def test_keyframe_lower_bound(self):
...
class TestModuleProcessing:
    ...
    def test_audio_extractor_time(self):
        """Test audio extractor processing time."""
        time_ms = 200
        assert time_ms < 500
    
    def test_whisper_gpu_time(self):
        """Test Whisper GPU processing time."""
        time_ms = 1500
        assert time_ms < 2000
    
    def test_translator_time(self):
        """Test translator processing time."""
        time_ms = 300
        assert time_ms < 500
    
    def test_tts_gpu_time(self):
        """Test TTS GPU processing time."""
        time_ms = 500
        assert time_ms < 1000
    
    def test_audio_mixer_numpy_time(self):
        """Test audio mixer numpy processing time."""
        time_ms = 20
        assert time_ms < 100
    
    def test_hls_output_time(self):
...
class TestTotalLatency:
    ...
    def test_optimal_case_latency(self):
    ...
    def test_typical_case_latency(self):
