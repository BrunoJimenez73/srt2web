...
class TestConfigPersistence:
    ...
    def test_config_piper_voice_persists(self):
    ...
    def test_config_chunk_duration_persists(self):
    ...
    def test_config_hls_settings_persists(self):
...
class TestPiperVoices:
    ...
    def test_piper_models_directory_exists(self):
    ...
    def test_piper_voices_exist(self):
    ...
    def test_piper_voices_in_tts_config(self):
...
class TestModuleStatusIndicators:
    ...
    def test_moduleMap_in_index_astro(self):
    ...
    def test_all_modules_in_moduleMap(self):
    ...
    def test_indicator_ids_exist_in_components(self):
...
class TestGPUBadgeDisplay:
    ...
    def test_gpu_badge_elements_exist(self):
    ...
    def test_gpu_badge_css_exists(self):
    ...
    def test_gpu_badge_logic_in_index_astro(self):
...
class TestDeviceEncoderMetrics:
    ...
    def test_device_metric_elements_exist(self):
    ...
    def test_encoder_metric_elements_exist(self):
    ...
    def test_device_encoder_logic_in_index_astro(self):
...
class TestBackendStatusAPI:
    ...
    def test_pipeline_status_has_modules(self):
    ...
    def test_pipeline_status_returns_extra(self):
    ...
    def test_transcriber_returns_device_in_status(self):
    ...
    def test_tts_engine_returns_device_in_status(self):
    ...
    def test_hls_output_returns_encoder_in_status(self):
...
class TestOutputMultiOutput:
    ...
    def test_output_card_has_add_button(self):
    ...
    def test_output_card_has_delete_button(self):
    ...
    def test_api_routes_has_outputs_endpoint(self):
    ...
    def test_api_routes_has_add_output_endpoint(self):
...
class TestMetricsDisplay:
    ...
    def test_time_metric_elements_exist(self):
    ...
    def test_chunks_metric_elements_exist(self):
...
class TestRefreshModuleStatus:
    ...
    def test_status_poll_interval_exists(self):
    ...
    def test_status_fetch_to_api(self):
