...
class TestTranslator:
    ...
    def test_start(self, mock_load) -> None:
        """Test module startup."""
    ...
    def test_load_language_model_already_installed(self) -> None:
    ...
    def test_load_language_model_not_installed(self) -> None:
    ...
    def test_load_language_model_not_found(self) -> None:
    ...
    def test_do_process_no_transcript(self) -> None:
    ...
    def test_do_process_no_pipeline(self) -> None:
