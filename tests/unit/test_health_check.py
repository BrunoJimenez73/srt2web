...
class TestHealthEndpoint:
    ...
    def test_health_returns_memory(self, client):
    ...
    def test_health_returns_modules(self, client):
    ...
    def test_health_returns_input_info(self, client):
    ...
    def test_health_returns_output_info(self, client):
    ...
    def test_health_returns_chunks_processed(self, client):
...
class TestHealthModuleStatus:
    ...
    def test_module_status_fields(self, client):
    ...
    def test_module_circuit_state(self, client):
    ...
    def test_module_state_values(self, client):
...
class TestHealthDegradedStatus:
    ...
    def test_healthy_when_all_modules_running(self, client):
    ...
    def test_degraded_when_circuit_open(self, client):
    ...
    def test_unhealthy_when_module_has_error(self, client):
...
class TestHealthInputOutput:
    ...
    def test_input_receiving_field(self, client):
    ...
    def test_output_streaming_field(self, client):
    ...
    def test_input_type_field(self, client):
    ...
    def test_output_type_field(self, client):
