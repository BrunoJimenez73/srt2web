...
class TestAudioMixerDurationCache:
    """Test the duration management in AudioMixer."""
...
class TestTTSAsyncioOptimization:
    ...
    def test_tts_uses_asyncio_run(self) -> None:
        ...
        with open("modules/tts_engine.py") as f:
            content = f.read()
        ...
        assert "asyncio.new_event_loop()" not in content, "TTS should not create new event loops manually"
...
class TestModelCacheIntegration:
    ...
    def test_transcriber_uses_model_cache(self) -> None:
        ...
        with open("modules/transcriber.py") as f:
            content = f.read()
    ...
    def test_translator_uses_model_cache(self) -> None:
        ...
        with open("modules/translator.py") as f:
            content = f.read()
