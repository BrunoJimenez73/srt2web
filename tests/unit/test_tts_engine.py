...
class TestTTSEngine:
    ...
    @patch("os.makedirs")
    def test_ensure_piper_model_download(self, mock_makedirs, mock_exists, mock_retrieve):
    ...
    def test_run_piper_tts(self, mock_wave_open):
        ...
        mock_voice.synthesize.assert_called_once_with("Hello", mock_wave_open().__enter__())
